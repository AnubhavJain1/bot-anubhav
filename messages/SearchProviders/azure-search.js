...
function create(serviceName, serviceKey, index) {
    ...
    //    "/indexes/" + index +
      //  "/docs?api-version=2016-09-01";
        "/indexes('" + index + "')" +
        "/docs/search.post.search?api-version=2015-02-28-Preview";
    //https://unscrambl.search.windows.net/indexes/poi-index/docs?api-version=2016-09-01&search=helo
    //https://unscrambl.search.windows.net/indexes/poi-index/docs?api-version=2016-09-01&search=*
